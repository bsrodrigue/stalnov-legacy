...
auth_urlpatterns = [
    ...
    path(
        ...
        auth_views.LoginView.as_view(
            extra_context=LOGIN_PAGE_CONTEXT,
            template_name="accounts/forms/auth/login.html",
        ),
        name="login",
    ),
...
reader_urlpatterns = [
    ...
    path("chapter/<int:novel_id>/<int:chapter_index>", default.chapter, name="chapter"),
    ...
    path("like_chapter", default.ChapterLikeView.as_view(), name="like_chapter"),
    path("unlike_chapter", default.ChapterUnlikeView.as_view(), name="unlike_chapter"),
    path(
...
writer_urlpatterns = [
    ...
    path("chapters/<int:novel_id>", writer.ChapterDashboard.as_view(), name="chapters"),
    path("new_novel", writer.NovelCreationView.as_view(), name="new_novel"),
    path(
        "edit_novel/<int:novel_id>",
        writer.NovelEditionView.as_view(),
        name="edit_novel",
    ),
    path("bulk_action", writer.BulkActionView.as_view(), name="bulk_dashboard_action"),
    path("delete_novel/<int:novel_id>", default.delete_novel, name="delete_novel"),
    path(
        "new_chapter/<int:novel_id>",
        writer.ChapterCreationView.as_view(),
        name="new_chapter",
    ),
    path(
        "edit_chapter/<int:chapter_id>",
        writer.ChapterEditionView.as_view(),
        name="edit_chapter",
    ),
